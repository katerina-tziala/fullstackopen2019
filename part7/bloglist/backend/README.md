...
**2.** Navigate from your terminal inside the /part7/bloglist/backend folder and run ***npm install*** or ***npm i*** to install the dependencies of the app.
...
**4.**  Navigate from your terminal inside the /part7/bloglist/backend folder and run ***npm run init-app-db*** to initialize the database and create a user for the app. The user that will be created is:
...
In order to execute the unit tests on the app navigate from your terminal inside the /part7/bloglist/backend folder and run ***npm run unit-test***.


### Integration Testing

In order to execute the integration tests on the app navigate from your terminal inside the /part7/bloglist/backend folder and run ***npm run test-api***.
